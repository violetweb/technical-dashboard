<?php
/*
Plugin Name: Violetweb Dashboard Widget
Plugin URI: http://violetweb.ca
Description: Dashboard widget for listings
Version: 1.0
Author: Valerie Trotter
Author URI: http://vioeltweb.ca
License: GPLv2 or later
*/

add_action('wp_dashboard_setup', array('Violetweb_Dashboard_Widget','init') );
class Violetweb_Dashboard_Widget {

    /**
     * The id of this widget.
     */
    const wid = 'listing_widget_example';
    ...
    public static function init() {
        ...
        wp_add_dashboard_widget(
            ...
            __( 'Violetweb Dashboard Widget', 'nouveau' ),//Visible name for the widget
            array('Violetweb_Dashboard_Widget','widget'),      //Callback for the main widget content
            array('Violetweb_Dashboard_Widget','config')       //Optional callback for widget configuration content
        );
    }
